...
%for j = 1:18
        ...
        for i = n_r:-1:0
            ...
            if (n_r==0)&&(u_r<=delta)
                ...
                % BRAM_int write
                [test,w_int_plus,w_int_minus] = w_int_div(CAd_plus_sel,CAd_minus_sel,v_int_plus, v_int_minus,i, shift_out_plus,shift_out_minus,count_one_plus,count_one_minus,k);
